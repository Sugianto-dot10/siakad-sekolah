...
<div class="card shadow-sm border-0 mb-4" style="border-radius: 12px;">
    <div class="card-body bg-light">
        <form action="{{ route('admin.nilai.index') }}" method="GET" class="row g-2 align-items-end">
            <div class="col-md-4">
                <label class="form-label fw-bold text-secondary small">Filter Kelas</label>
            ...
            <div class="col-md-5">
                <label class="form-label fw-bold text-secondary small">Filter Mata Pelajaran</label>
                <select name="mapel_id" class="form-select shadow-sm">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-hover align-middle">
                ...
                <tbody>
                    @forelse($data_nilai as $index => $nilai)
                    <tr>
                        <td>{{ $index + 1 }}</td>
                    ...
                    @empty
                    <tr>
                        <td colspan="10" class="text-center text-muted py-4">Data nilai tidak ditemukan untuk filter ini.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
